...
describe('listAllSkills', () => {
    ...
    it('should return 403 if API_KEY is missing', () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, skillsController_1.listAllSkills)(mockRequest, mockResponse);
    ...
    it('should return 200 with skills if API_KEY is valid', () => __awaiter(void 0, void 0, void 0, function* () {
        const mockSkills = [{ name: 'JavaScript' }, { name: 'TypeScript' }];
        skillsRepository_1.listSkills.mockResolvedValue(mockSkills);
        ...
        expect(skillsRepository_1.listSkills).toHaveBeenCalledTimes(1);
    }));
    it('should return 500 if listSkills throws an error', () => __awaiter(void 0, void 0, void 0, function* () {
        skillsRepository_1.listSkills.mockRejectedValue(new Error('Database error'));
        process.env.API_KEY_NODE = 'valid_api_key';
        mockRequest.query = { api_key: 'valid_api_key' };
        yield (0, skillsController_1.listAllSkills)(mockRequest, mockResponse);
...
//# sourceMappingURL=listSkills.test.js.map